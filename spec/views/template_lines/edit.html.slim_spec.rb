...
RSpec.describe "template_lines/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit template_line form" do
    render

    assert_select "form[action=?][method=?]", template_line_path(@template_line), "post" do
